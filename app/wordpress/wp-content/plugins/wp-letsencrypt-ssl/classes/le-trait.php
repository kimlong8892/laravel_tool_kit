...
class WPLE_Trait
{
    ...
    public static function wple_headernav( &$html )
    {
        ...
        <li><a href="' . admin_url( '/admin.php?page=wp_encryption_howto_videos' ) . '"><span class="dashicons dashicons-video-alt3"></span> ' . esc_html__( 'Videos', 'wp-letsencrypt-ssl' ) . '</a></li>';
                ...
                ///$html .= '<li><a href="https://wordpress.org/plugin/wordmagic-content-writer/" target="_blank" class="wple-tooltip" data-tippy="(New) Most advanced GPT-3 based AI Content Writer plugin"><span class="dashicons dashicons-admin-plugins"></span> ' . esc_html__('WordMagic AI', 'wp-letsencrypt-ssl') . '</a></li>';
