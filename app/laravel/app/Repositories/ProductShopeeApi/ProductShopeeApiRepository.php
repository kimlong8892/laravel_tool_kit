...
class ProductShopeeApiRepository implements ProductShopeeApiRepositoryInterface {
    public function getListProductApi($keyword = '', $page = 1) {
        ...
        $body = '{"query":"{  productOfferV2 (page: ' . (int)$page . ', limit: 10, keyword: \"' . $keyword . '\") {    nodes {itemId price imageUrl productName offerLink productLink}, pageInfo { page limit hasNextPage }  }}","variables":null,"operationName":null}';
